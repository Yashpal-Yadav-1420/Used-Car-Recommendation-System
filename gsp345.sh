...
echo "${BLUE_TEXT}${BOLD_TEXT}                  🚀 GOOGLE CLOUD LAB | Google Cloud Arcade           ${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}======================================================================${RESET_FORMAT}"
echo
...
echo "${BLUE_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}🙏 Thank you for learning with Google Cloud Arcade!${RESET_FORMAT}"
echo "${RED_TEXT}${BOLD_TEXT}📢 Subscribe Google CLoud Arcade for more hands-on Google Cloud Labs:${RESET_FORMAT}"
echo "${BLUE_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}https://www.youtube.com/@GoogleCloudArcade-j4p${RESET_FORMAT}"
echo
